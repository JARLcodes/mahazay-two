...
class Navbar extends Component {
    render() {
        ...
        return ( 
            <ResponsiveMenu menuOpenButton = { < div / > }
                menuCloseButton = { < div / > }
                changeMenuOn = "500px"
                ...
                menu = { 
                    ...
                    <Link to = "/" style = {{ textDecoration: "none" }} >
                        <img src = "https://i.pinimg.com/564x/d6/3b/f1/d63bf1221116ebb6102c77e7e9a74808.jpg" alt="home" style = {{ height: 75, width: 75, paddingRight: "1em" }}/> 
                    </Link> 
                <Link to = "/" style = {{ textDecoration: "none" }}>
                ...
                <Button href = "/tracker" color = "inherit" style = {{ color: "#EF9A9A", marginLeft: '1em', marginRight: '1em' }} disabled = { disabled } >
                    <CheckBox / >
                    Tracker 
                </Button> 
                {
                ...
                {
                user 
                ? <Button href = "/"color = "inherit"style = {{ color: "#424242" }} onClick = { () => auth.signOut() }>
                    <Person / >
                        Logout 
                    </Button>
                : null
